...
export default class BaseEngine {
    ...
    constructor() {
        ...
        try {
            ...
            console.error("WebGL context could not be created.", e);
            alert("WebGL is not supported or could not be initialized. Please make sure your browser supports WebGL.");
        }
